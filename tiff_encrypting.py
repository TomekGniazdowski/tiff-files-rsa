...
class TiffEncrypting(tm.Tiff_manipulations):
    ...
    def rsa_encrypt(self):
        idx = 0
        for chunk in self.data_hex_list_div_int:
            self.data_hex_list_div_int_enc[idx] = pow(chunk, self.e, self.n)
            idx += 1
    ...
    def connect_chunks_encrypted(self):
        ...
        self.how_inc = 0
        self.data_hex_list_conn_enc_1 = ['0' for x in range(len(self.data_hex_list_div_int_enc))]
